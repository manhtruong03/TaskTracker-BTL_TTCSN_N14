...
public class Project extends TrelloModel {
	...
	public String toString() {
		return "Project [" + super.toString() + " projectName=" + projectName + ", description=" + description + ", startDate=" + startDate
				+ ", endDate=" + endDate + ", status=" + status + ", backGroundImage=" + backGroundImage + "]";
	}
